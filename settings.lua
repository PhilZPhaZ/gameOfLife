...
function settings.draw()
    ...
    love.graphics.print('Espace ou flèche droite : Générer une nouvelle génération', 100, 300)
    love.graphics.print('Entrée ou retour arrière : Effacer la grille', 100, 350)
